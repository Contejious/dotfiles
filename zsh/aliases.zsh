...
alias store_cleanup="find . -name '*.DS_Store' -type f -ls -delete"
...
alias k2exec="kubectl -n region2 exec -it"
alias k2pods="kubectl -n region2 get pods | grep"


alias tn="tmux new -t $1"
alias ta="tmux a -t $1"
alias tl="tmux ls"
